...
/mnt/SDCARD/System/usr/miyoo/scripts/infoscreen.sh -m "Applying \"$(basename "$0")\" by default..."
...
/mnt/SDCARD/System/usr/miyoo/scripts/mainui_state_update.sh "Scrape In Background" "$BackgroundState"